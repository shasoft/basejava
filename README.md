...
### Изучите [бесплатный урок](https://github.com/JavaWebinar/basejava/blob/lesson/lesson/lesson01.md). В конце урока находится домашнее задание, по которому можно оценить свой уровень готовности к проекту
